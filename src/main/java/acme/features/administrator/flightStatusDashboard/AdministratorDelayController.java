...
@GuiController
public class AdministratorDelayController {
	// Internal state ---------------------------------------------------------

	@Autowired
	private AdministratorDelayCreateService createService;

	// Constructors -----------------------------------------------------------


	@GetMapping("/administrator/delay/populate")
	public ModelAndView populateInitial() {
		...
		try {
			this.createService.getAllDelays();
